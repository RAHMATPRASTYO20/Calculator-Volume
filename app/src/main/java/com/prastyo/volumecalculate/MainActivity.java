package com.prastyo.volumecalculate;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_calculate) {
            ...
            if (TextUtils.isEmpty(length)) {
                isEmptyFields = true;
                edtLength.setError("Iki tulung diisi to rek!");
            }else if (!isDouble(length)) {
                isInvalidDouble = true;
                edtLength.setError("Nek ngisi iki kudu angka la");
            }

            if (TextUtils.isEmpty(width)) {
                isEmptyFields = true;
                edtWidth.setError("Iki tulung diisi to rek!");
            }else if (!isDouble(width)) {
                edtWidth.setError("Nek ngisi iki kudu angka la");
            }

            if (TextUtils.isEmpty(height)) {
                isEmptyFields = true;
                edtHeight.setError("Iki tulung diisi to rek!");
            }else if (!isDouble(height)) {
                edtHeight.setError("Nek ngisi iki kudu angka la");
            }
